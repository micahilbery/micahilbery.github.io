...
date: 2020-03-01
live-url: "https://micahilbery.com/shades-icon-set/"
project_id: shades
css: true
---
...
<section id="icon-panel" class="grid panel icon-panel">
  ...
  <div class="icon-grid">
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="aeropress"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="alcohol"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="chemex"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="contrast"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="fire"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="qr"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="tree"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="usd"  %}</div>
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="wine"  %}</div>
  ...
  <div class="icon-grid">
    ...
    <div class="icon-container">
      <div class="icon-preview">{% include modules/icon.html name="zelda-ocarina"  %}</div>
